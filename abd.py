...
def crashed():
   ...
   while True:
        ...
        button("RETRY",200,200,100,50,orchid,bright_green,gameloop)
        button("Quit",900,200,100,50,red,bright_red,quitgame)
...
def game_intro():
    ...
    while intro:
        ...
        button("START",120,200,150,85,blue,bright_green,gameloop)
        button("Quit",900,200,150,85,green,bright_red,quitgame)
